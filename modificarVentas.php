<?php
    ...
    include 'modificarVentasLogica.php';
?>
...
<?php if (isset($_GET['error'])) { ?>
    ...
    <form action="modificarVentas.php" method="POST" class="form-register">
        <h4 align="center">Modificar Ventas</h4>
        ...
        <input type="submit" value="Modificar ventas" class="botons" id="updBtn">
    </form>
