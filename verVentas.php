<?php
    ...
    $consulta = "SELECT * FROM registrarventas";
                    ...
                    <tbody>
                        <?php 
                            while($fila = $consulta->fetch_assoc()){
                                ...
                                echo "<td class='text-center'>".$fila['id_cliente']."</td>";
                                ...
                                echo "<td class='text-center'>
                                        <a href='modificarVentas.php?id=".$fila['id']."' class='btn btn-warning'>Editar</a>
                                        <a href='eliminarVentas.php?id=".$fila['id']."' class='btn btn-danger'>Eliminar</a>
                                    </td>";
                                echo "</tr>";
                            }
                        ?>
