<?php
    ...
    $consulta = "SELECT * FROM registraringresos";
                        ...
                        <?php 
                            while($fila = $consulta->fetch_assoc()){
                                ...
                                echo "<td class='text-center'>
                                        <a href='modificarIngresos.php?id=".$fila['id']."' class='btn btn-warning'>Editar</a>
                                        <a href='eliminarIngresos.php?id=".$fila['id']."' class='btn btn-danger'>Eliminar</a>
                                    </td>";
                                echo "</tr>";
                            }
                        ?>
